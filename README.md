...
This project is still experimental and in code review https://users.rust-lang.org/t/safe-to-use-macro-free-self-referential-structs-in-stable-rust/52775 it's quite possible the API cannot be made sound.
